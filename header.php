    ...
    <div class="shadow-sm">
        <div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
            <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-24 ltr:-ml-1 rtl:-mr-1 inline" src="/php/pim/assets/images/logo2.webp" alt="image" />
                    <!-- <span class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">PIM</span> -->
                </a>
            ...
            <div class="ltr:mr-2 rtl:ml-2 hidden sm:block">
                <ul class="flex items-center space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                    <li>
                        <a  class="block p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <li><a class="block p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div x-data="header" class="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                ...
                <!-- <div>
                    <a href="javascript:;" x-cloak x-show="$store.app.theme === 'light'" href="javascript:;"
                        class="flex items-center p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60" @click="$store.app.toggleTheme('dark')">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="javascript:;" x-cloak x-show="$store.app.theme === 'dark'" href="javascript:;"
                        class="flex items-center p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60" @click="$store.app.toggleTheme('system')">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <a href="javascript:;" x-cloak x-show="$store.app.theme === 'system'" href="javascript:;"
                        class="flex items-center p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60" @click="$store.app.toggleTheme('light')">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="dropdown shrink-0" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="block p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60" @click="toggle">
                        <img :src="`/php/pim/assets/images/flags/${$store.app.locale.toUpperCase()}.svg`" alt="image" class="w-5 h-5 object-cover rounded-full" />
                    </a>
                        ...
                        <template x-for="item in languages">
                            <li>
                                <a href="javascript:;" class="hover:text-primary" @click="$store.app.toggleLocale(item.value),toggle()" :class="{'bg-primary/10 text-primary' : $store.app.locale == item.value}">
                                    <img class="w-5 h-5 object-cover rounded-full" :src="`/php/pim/assets/images/flags/${item.value.toUpperCase()}.svg`" alt="image" />
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms class="top-11 !py-0 text-dark dark:text-white-dark w-[300px] ltr:-right-16 sm:ltr:-right-2 rtl:-left-16 sm:rtl:-left-2 sm:w-[375px] text-xs">
                        <li class="mb-5">
                            <div class="overflow-hidden relative rounded-t-md !p-5 text-white">
                                <div class="absolute h-full w-full bg-[url('/php/pim/assets/images/menu-heade.jpg')] bg-no-repeat bg-center bg-cover inset-0"></div>
                                ...
                                <div class="flex items-center px-4 py-2 group" @click.self="toggle">
                                    <div class="grid place-content-center rounded">
                                        <div class="w-12 h-12 relative">
                                            <img class="w-12 h-12 rounded-full object-cover" :src="`/php/pim/assets/images/${notification.profile}`" alt="image" />
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="relative group" @click="toggle()">
                        <span><img class="w-9 h-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src="/php/pim/assets/images/user.png" alt="image" /></span>
                    </a>
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms class="ltr:right-0 rtl:left-0 text-dark dark:text-white-dark top-11 !py-0 w-[230px] font-semibold dark:text-white-light/90">
                        <li>
                            <div class="flex items-center px-4 py-4">
                                <div class="flex-none">
                                    <img class="rounded-md w-10 h-10 object-cover" src="/php/pim/assets/images/user.png" alt="image" />
                                </div>
                                <div class="ltr:pl-4 rtl:pr-4 truncate">
                                    <h4 class="text-base"><?php echo $_SESSION['name']?><span class="text-xs bg-success-light rounded text-success px-1 ltr:ml-2 rtl:ml-2"><?php echo $_SESSION['role']?></span></h4>
                                    <a class="text-black/60  hover:text-primary dark:text-dark-light/60 dark:hover:text-white" href="javascript:;"><?php echo $_SESSION['email']?></a>
                                </div>
                            </div>
                        </li>
                        <li class="border-t border-white-light dark:border-white-light/10">
                            <a href="/php/pim/pages/logout.php" class=" text-danger !py-3" @click="toggle">
        ...
        <ul class="horizontal-menu hidden py-1.5 font-semibold px-6 lg:space-x-1.5 xl:space-x-8 rtl:space-x-reverse bg-white border-t border-[#ebedf2] dark:border-[#191e3a] dark:bg-[#0e1726] text-black dark:text-white-dark">
            ...
            <li class="menu nav-item relative">
                ...
                <ul class="sub-menu">
                    <li>
                        <a href="/php/pim/apps/chat.php">Chat</a>
                    </li>
                    <li>
                        <a href="/php/pim/apps/mailbox.php">Mailbox</a>
                    </li>
                    <li>
                        <a href="/php/pim/apps/todolist.php">Todo List</a>
                    </li>
                    <li>
                        <a href="/php/pim/apps/notes.php">Notes</a>
                    </li>
                    <li>
                        <a href="/php/pim/apps/scrumboard.php">Scrumboard</a>
                    </li>
                    <li>
                        <a href="/php/pim/apps/contacts.php">Contacts</a>
                    </li>
                    <li class="relative">
                        ...
                        <ul class="rounded absolute top-0 ltr:left-[95%] rtl:right-[95%] min-w-[180px] bg-white z-[10] text-dark dark:text-white-dark dark:bg-[#1b2e4b] shadow p-0 py-2 hidden">
                            <li>
                                <a href="/php/pim/apps/invoice/list.php">List</a>
                            </li>
                            <li>
                                <a href="/php/pim/apps/invoice/preview.php">Preview</a>
                            </li>
                            <li>
                                <a href="/php/pim/apps/invoice/add.php">Add</a>
                            </li>
                            <li>
                                <a href="/php/pim/apps/invoice/edit.php">Edit</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="/php/pim/apps/calendar.php">Calendar</a>
                    </li>
                </ul>
            </li>
            <li class="menu nav-item relative">
            ...
            <li class="menu nav-item relative">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="relative">
                        ...
                        <ul class="rounded absolute top-0 ltr:left-[95%] rtl:right-[95%] min-w-[180px] bg-white z-[10] text-dark dark:text-white-dark dark:bg-[#1b2e4b] shadow p-0 py-2 hidden">
                            <li>
                                <a href="/php/pim/auth/cover-login.php" target="_blank">Login Cover</a>
                            </li>
                            <li>
                                <a href="/php/pim/auth/boxed-signin.php" target="_blank">Login Boxed</a>
                            </li>
                        </ul>
                    </li>
                    <li class="relative">
                        ...
                        <ul class="rounded absolute top-0 ltr:left-[95%] rtl:right-[95%] min-w-[180px] bg-white z-[10] text-dark dark:text-white-dark dark:bg-[#1b2e4b] shadow p-0 py-2 hidden">
                            <li>
                                <a href="/php/pim/auth/cover-register.php" target="_blank">Register Cover</a>
                            </li>
                            <li>
                                <a href="/php/pim/auth/boxed-signup.php" target="_blank">Register Boxed</a>
                            </li>
                        </ul>
                    </li>
                    <li class="relative">
                        ...
                        <ul class="rounded absolute top-0 ltr:left-[95%] rtl:right-[95%] min-w-[180px] bg-white z-[10] text-dark dark:text-white-dark dark:bg-[#1b2e4b] shadow p-0 py-2 hidden">
                            <li>
                                <a href="/php/pim/auth/cover-password-reset.php" target="_blank">Recover ID Cover</a>
                            </li>
                            <li>
                                <a href="/php/pim/auth/boxed-password-reset.php" target="_blank">Recover ID Boxed</a>
                            </li>
                        </ul>
                    </li>
                    <li class="relative">
                        ...
                        <ul class="rounded absolute top-0 ltr:left-[95%] rtl:right-[95%] min-w-[180px] bg-white z-[10] text-dark dark:text-white-dark dark:bg-[#1b2e4b] shadow p-0 py-2 hidden">
                            <li>
                                <a href="/php/pim/auth/cover-lockscreen.php" target="_blank">Unlock Cover</a>
                            </li>
                            <li>
                                <a href="/php/pim/auth/boxed-lockscreen.php" target="_blank">Unlock Boxed</a>
                            </li>
                        </ul>
                    </li>
                </ul>
