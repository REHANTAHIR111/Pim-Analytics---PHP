...
<div x-data="custom">
    <div class="panel">
        <div class="flex gap-3 items-center absolute top-5">
            ...
            <?php endif; ?>
            <?php if ($create) : ?>
                <a href='/php/pim/pages/brand/add.php' class='btn btn-dark'>
                    <svg width="20" height="20" viewBox="0 0 24 24" stroke="white" stroke-width="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
...
<script>
        ...
        Alpine.data("custom", () => ({
            ...
            init() {
                ...
                const data = this.tableData.map(user => {
                    const id = user[0];
                    const mobileImage = user[3] || '';
                    const websiteImage = user[4] || '';
    ...
    document.getElementById('bulkDeleteBtn').addEventListener('click', function() {
        ...
        form.method = 'POST';
        form.action = '/php/pim/pages/brand/delete.php';
