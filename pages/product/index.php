...
<div x-data="custom">
    <div class="panel">
        <div class="flex gap-3 items-center absolute top-5">
            ...
            <?php endif; ?>
            <?php if ($create) : ?>
                <a href='/php/pim/pages/product/add.php' class="btn btn-dark">Create Product</a>
            <?php endif; ?>
        </div>
...
<script>
            ...
            init() {
                ...
                const data = this.tableData.map(user => {
                    ...
                    return [
                        ...
                        `<span style="width: 150px; overflow-x: auto; display: inline-block;">${user[2]}</span>`,
                        user[3],
                        user[4],
                        user[5],
                        `<span style="width: 150px; overflow-x: auto; display: inline-block;">${user[6]}</span>`,
                        `<span style="width: 300px; overflow-x: auto; display: inline-block;">${user[7]}</span>`,
                        user[8],
                        user[9],
                        user[10],
                    ];
    ...
    document.getElementById('bulkDeleteBtn').addEventListener('click', function() {
        ...
        form.method = 'POST';
        form.action = '/php/pim/pages/product/delete.php';
