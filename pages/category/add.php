                ...
                <div class="px-0 flex-1 py-0 ltr:xl:mr-1 rtl:xl:ml-1">
                    <div class="panel mb-5 flex items-center gap-3">
                        ...
                        <input
                            ...
                            value="http://localhost/php/pim/pages/category/<?= htmlspecialchars(basename($old['slug'] ?? '')) ?>"
                            readonly
                        />
                    ...
                    <div class="mb-5" x-data="{
                        ...
                        category_description: '<?= htmlspecialchars($old['category_description'] ?? '') ?>',
                        nameAr: '<?= htmlspecialchars($old['nameAr'] ?? '') ?>',
                        h1Ar: '<?= htmlspecialchars($old['h1Ar'] ?? '') ?>',
                        category_descriptionAr: '<?= htmlspecialchars($old['category_descriptionAr'] ?? '') ?>'
                    }">
                        <div>
                    ...
                    <div class="mb-5" x-data="{
                        ...
                        meta_canonical: '<?= htmlspecialchars($old['meta_canonical'] ?? '') ?>',
                        ...
                        meta_canonicalAr: '<?= htmlspecialchars($old['meta_canonicalAr'] ?? '') ?>',
                ...
                <div class="xl:w-96 w-full xl:mt-0 mt-6">
                        ...
                        <div class="grid grid-cols-2 gap-3 mt-3">
                            ...
                            <label class="mt-3 b-0">
                                <input
                                    ...
                                    class="form-checkbox"
                                    value="1"
                                    <?= (isset($old['not_for_export']) && $old['not_for_export']) ? 'checked' : '' ?>
                                />
                            ...
                            <label class="mt-3 b-0">
                                <input
                                    ...
                                    class="form-checkbox"
                                    value="1"
                                    <?= (isset($old['show_in_menu']) && $old['show_in_menu']) ? 'checked' : '' ?>
                                />
                            ...
                            <label class="mt-3 b-0">
                                <input
                                    ...
                                    class="form-checkbox"
                                    value="1"
                                    <?= (isset($old['show_on_arabyads']) && $old['show_on_arabyads']) ? 'checked' : '' ?>
                                />
                    ...
                    <div class="mb-3 panel">
                        <div class="grid grid-cols-2 gap-3">
                            <label class="mb-0">
                                <input
                                    ...
                                    class="form-checkbox"
                                    value="1"
                                    <?= (isset($old['no_follow']) && $old['no_follow']) ? 'checked' : '' ?>
                                />
                            ...
                            <label class="mb-0">
                                <input
                                    ...
                                    class="form-checkbox"
                                    value="1"
                                    <?= (isset($old['no_index']) && $old['no_index']) ? 'checked' : '' ?>
                                />
                        ...
                        <div class='mt-5'>
                            ...
                            <input type="text" name="redirection_link" id="redirection_link" class="form-input" value='<?= htmlspecialchars($old['redirection_link'] ?? '') ?>' placeholder='Enter Redirection Link'>
                            <small style="color: #b91c1c;" class="mt-1"><?= htmlspecialchars($errors['redirection_link'] ?? '') ?></small>
                        </div>
                    </div>
                    <div class="mb-3 panel space-y-3">
                        <div x-data="{ selectedType: '<?php echo $old['selltype'] ?? '1'; ?>' }">
                        ...
                        <div>
                            ...
                            <input type="text" name='value' id='value' class='form-input' value='<?= htmlspecialchars($old['value'] ?? '') ?>'>
                        </div>
                    </div>
                    <div class="mb-3 panel space-y-3">
                        <div>
                            <label for="">Its a Parent Category</label>
                            <select name="selectCat" id="selectCat" class="form-select">
                                <option value="" disabled selected>Select</option>
                                <?php
                                    foreach ($catOptions as $cat) {
                                        $selected = (isset($old['selectCat']) && $old['selectCat'] == $cat['id']) ? 'selected' : '';
                        ...
                        <div>
                            ...
                            <select name="selectSubtag[]" id="selectSubtag" class="w-full form-multiselect" multiple>
                                <option value="" disabled>Select</option>
                                <?php
                                    while ($subTags = mysqli_fetch_assoc($subTagsOptions)) {
                                        $selected = (isset($old['selectSubtag']) && in_array($subTags['id'], $old['selectSubtag'])) ? 'selected' : '';
                    ...
                    <div class="mb-3 panel space-y-3">
                        <div>
                            ...
                            <textarea name="upload_icon" id="upload_icon" class="form-input h-20" placeholder='Icon...' ><?= htmlspecialchars($old['upload_icon'] ?? '') ?></textarea>
                        </div>
                        <div>
                            <label for="brand_link">Brand Link</label>
                            <input type="text" name="brand_link" id="brand_link" class="form-input" placeholder='Link' value='<?= htmlspecialchars($old['brand_link'] ?? '') ?>'>
                        </div>
                        <div>
                            ...
                            <input type="text" name="image_link" id="image_link" class="form-input" placeholder='Link' value='<?= htmlspecialchars($old['image_link'] ?? '') ?>'>
                        </div>
                    </div>
                    <div class="panel mb-3">
                        ...
                        <div class="relative rounded-md mt-3 overflow-hidden w-full max-w-sm" id="mobilePreview">
                            <?php $image_mobile = $old['image_mobile'] ?? ''; ?>
